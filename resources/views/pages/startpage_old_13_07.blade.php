							...
							<div class="small-12 columns">
								...
								<div class="row">
									<div class="medium-6 columns">
										...
										<ul>
											<li><span class="blue">01</span> Füllen Sie einfach das obenstehende Formular aus
											<li><span class="blue">02</span> Bestätigen Sie die von uns geschickte E-Mail
											<li><span class="blue">03</span> Sehen Sie sich das Profil Ihres Zahntechnikermeisters vom Dentallabor in Ihrer Nähe an
											<li><span class="blue">04</span> Sie werden von Ihrem Zahntechnikermeister kontaktiert und können einen Termin vereinbaren
											<li><span class="blue">05</span> Sie erhalten eine individuelle, kostenlose Beratung im Dentallabor
										</ul>
									</div>
									<div class="medium-6 columns">
										<h3><img src="/img/stern.svg" /> Ihre Vorteile</h3>
										<ul>
											<li><span class="blue">01</span> Die Beratung ist für Sie kostenlos und wertvoll
					...
					<section class="snd-opinion section">
						<div class="row">
							<div class="small-12 columns">
								...
								<p><strong>Nehmen Sie jetzt Ihre Chance wahr</strong> und holen Sie sich <strong>eine professionelle 2. Meinung</strong> beim Zahntechniker und vielleicht auch bei einem anderen Zahnarzt, damit Sie wirklich mitreden können.<br/>Es geht um <strong>Ihre Zähne</strong>, um <strong>Ihr Aussehen</strong>, um <strong>Ihre Lebensqualität</strong>, um <strong>Ihre Gesundheit</strong> und um <strong>Ihr Geld</strong>. <br/>Patienten, die den Weg über Padento gegangen sind, hatten danach <strong>das gute Gefühl, eine richtige Entscheidung getroffen zu haben</strong>.</p>
							</div>
						</div>
					</section>
				</div>
